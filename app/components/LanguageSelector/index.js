...
const LanguageSelector = ({id, anchorEl, intl, value, handleChange, onClose}) => {
  ...
  return (
    ...
    <Menu id="language-menu" anchorEl={languageButton} open={Boolean(languageButton)} onClose={onClose}>
